...
def task_02_coalition_without_coordination():
    """
    Solve WITHOUT coordination (pure Ray and Vohra, 2001; overarching
    agreements are never considered) at both horizons (T = TP, short/
    myopic; T = TimeRange, long) and export:
      bld/tables/02_without_coord.txt         (TSV, short horizon, for quick inspection)
      bld/tables/without_coordination.json    (full snapshot: both horizons,
    ...
    json_out = table_path("without_coordination").with_suffix(".json")
